package net.pietrangelo.myapp.config.timezone;

import net.pietrangelo.myapp.MyappApp;
import net.pietrangelo.myapp.config.TestSecurityConfiguration;
import net.pietrangelo.myapp.repository.timezone.DateTimeWrapper;
import net.pietrangelo.myapp.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {MyappApp.class, TestSecurityConfiguration.class})
